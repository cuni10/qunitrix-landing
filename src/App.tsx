...
const CheckIcon = () => (
  <Icon
    ...
    className="w-5 h-5 text-[#0b818d] flex-shrink-0"
  />
);
...
const Nav: React.FC<{
  ...
  <header
    className="sticky top-0 z-50 px-6 lg:px-20 py-4 glass-card border-none"
...
const HeroSection: React.FC = () => (
  <section className="relative flex flex-col items-center justify-center px-6 pt-24 pb-32 text-center overflow-hidden">
    ...
    <div
      className="absolute top-32 left-1/2 -translate-x-1/2 w-[700px] h-[700px] rounded-full pointer-events-none animate-pulse-slow"
      style={{
        background:
    ...
    <div className="relative z-10 max-w-5xl mx-auto">
      ...
      <h1
        ...
        style={{ fontFamily: "'Lexend', sans-serif" }}
      >
        Transformamos <span className="text-gradient-blue">ideas</span>
        <br />
        en soluciones{" "}
      ...
      <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-12 leading-relaxed">
        En <strong className="text-white">Qunitrix</strong> desarrollamos
        software que impulsa la eficiencia operativa de empresas. Desde sistemas
        de gestión hasta soluciones a medida, llevamos tu negocio al siguiente
        nivel.
      </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-4xl mx-auto">
        {[
          ...
          >
            <span
              className="text-3xl font-black mb-1 text-gradient-blue"
              style={{ color: "#f39200" }}
            >
              {value}
            </span>
    ...
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-20">
        ...
        <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          Desarrollamos soluciones tecnológicas completas para empresas que
          buscan eficiencia, escalabilidad y ventaja competitiva.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map(({ icon, title, desc, tags }) => (
          <div
            key={title}
            className="glass-card card-hover-blue rounded-3xl p-8 flex flex-col gap-5"
          >
            <div
            ...
            <div className="flex flex-wrap gap-2 mt-auto">
              {tags.map((tag) => (
                <span
                  key={tag}
                  className="text-xs px-2.5 py-1 rounded-full text-blue-300 font-medium"
                  style={{
...
const StockAppSection: React.FC = () => (
  <section id="stockapp" className="px-6 py-32 relative overflow-hidden">
    ...
    <div
      ...
      style={{
        background:
          "radial-gradient(circle, rgba(11,129,141,0.12) 0%, transparent 70%)",
      }}
    />
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="text-center mb-16">
        <div className="badge-teal mb-6 justify-center">
        ...
        <h2
          ...
          style={{ fontFamily: "'Lexend', sans-serif" }}
        >
          <span className="text-gradient-teal">StockApp</span> — Gestión
          Comercial
        </h2>
        <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          Nuestra solución integral de punto de venta e inventario para
          comercios modernos. Rápido, intuitivo y completamente en la nube.
        </p>
      </div>

      {/* Main showcase card */}
      <div
        className="glass-card rounded-[2.5rem] overflow-hidden flex flex-col lg:flex-row mb-10"
        style={{ borderColor: "rgba(11,129,141,0.2)" }}
      >
        {/* Text side */}
        <div className="lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center">
          <div className="badge-teal mb-6 self-start">
            Plataforma en la Nube
          </div>
          <h3
            className="text-3xl md:text-4xl font-black mb-5 leading-tight text-white"
            style={{ fontFamily: "'Lexend', sans-serif" }}
          >
          ...
          <p className="text-slate-400 mb-8 leading-relaxed">
            StockApp combina punto de venta, control de inventario, reportes
            analíticos y gestión de distribuidores en una plataforma unificada y
            fácil de usar.
          </p>
        ...
        <div className="lg:w-1/2 flex items-center justify-center p-8 lg:p-10">
          <div
            ...
            style={{ border: "1px solid rgba(11,129,141,0.25)" }}
          >
            {/* Browser chrome */}
            <div
            ...
            >
              ...
              />
              <div
                className="flex-1 mx-4 px-3 py-1 rounded text-xs text-slate-500"
      ...
      <div
        className="glass-card rounded-[2.5rem] overflow-hidden flex flex-col lg:flex-row-reverse"
        style={{ borderColor: "rgba(11,129,141,0.15)" }}
      >
        <div className="lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center">
          <h3
            className="text-3xl font-black mb-5 text-white"
            style={{ fontFamily: "'Lexend', sans-serif" }}
          >
            Punto de Venta{" "}
          ...
          <p className="text-slate-400 mb-8 leading-relaxed">
            Cobrá en segundos con cualquier método de pago. Efectivo,
            transferencia, tarjeta o MercadoPago — todo integrado en una sola
            pantalla. Con búsqueda por teclado y navegación por flechas.
          </p>
          <ul className="space-y-3 mb-8">
            {[
              "Múltiples métodos de cobro en un click",
              "Descuentos por porcentaje o valor fijo",
              "Navegación total por teclado para máxima velocidad",
              "Tickets numerados y historial de ventas",
            ].map((f) => (
              <li
                key={f}
                className="flex items-start gap-3 text-slate-300 text-sm"
        ...
        <div className="lg:w-1/2 flex items-center justify-center p-8 lg:p-10">
          <div
            className="w-full rounded-2xl overflow-hidden shadow-2xl"
            style={{ border: "1px solid rgba(11,129,141,0.2)" }}
          >
            {/* Browser chrome */}
            <div
              className="flex items-center gap-2 px-4 py-3 border-b"
...
const whyItems = [
  {
    ...
    desc: "Código limpio, documentado y testeado. Cada entrega pasa por revisión exhaustiva.",
  },
  {
    icon: "M13 10V3L4 14h7v7l9-11h-7z",
    label: "Entregas rápidas",
    desc: "Metodologías ágiles que minimizan tiempos y maximizan el valor entregado en cada sprint.",
  },
  {
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z",
    label: "Equipo dedicado",
    desc: "Desarrolladores senior comprometidos con cada proyecto, desde el diseño hasta el deploy.",
  },
  {
    icon: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15",
    label: "Soporte continuo",
    desc: "Acompañamos tu crecimiento con soporte post-lanzamiento, actualizaciones y escalabilidad.",
  },
];
...
const AboutSection: React.FC = () => (
  <section id="nosotros" className="px-6 py-32 section-gradient relative">
    <div
      ...
      style={{
        background:
          "radial-gradient(circle, rgba(243,146,0,0.1) 0%, transparent 70%)",
      }}
    />
      ...
      <div className="grid lg:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          <h2
            ...
            style={{ fontFamily: "'Lexend', sans-serif" }}
          >
            Software que <span className="text-gradient-blue">transforma</span>
            <br />
            empresas reales
          </h2>
          <p className="text-slate-400 text-lg mb-6 leading-relaxed">
            Somos una empresa de desarrollo de software especializada en
            soluciones empresariales. Trabajamos con negocios de todos los
            tamaños para digitalizar, automatizar y escalar sus operaciones con
            tecnología de primer nivel.
          </p>
          <p className="text-slate-400 text-lg mb-10 leading-relaxed">
            Nuestro equipo combina expertise técnico con profundo entendimiento
            del mundo empresarial para entregar productos que realmente generan
            impacto.
          </p>
          <a
            href="#contacto"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {whyItems.map(({ icon, label, desc }) => (
            <div
              key={label}
              className="glass-card card-hover-blue rounded-2xl p-6"
            >
              <div
...
const CTASection: React.FC = () => (
  <section className="px-6 py-28 relative overflow-hidden">
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(243,146,0,0.12) 0%, rgba(11,129,141,0.06) 100%)",
      }}
    />
    <div
      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[300px] rounded-full blur-3xl pointer-events-none"
    ...
    <div className="max-w-4xl mx-auto text-center relative z-10">
      ...
      <p className="text-xl text-slate-400 mb-12 max-w-2xl mx-auto">
        Hablemos de tu proyecto. Nuestro equipo está listo para diseñar la
        solución tecnológica ideal para tu negocio.
      </p>
...
const ContactSection: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Necesitarás reemplazar estos IDs con los tuyos de EmailJS
  ...
  const inputClass =
    "w-full rounded-xl px-4 py-3 text-slate-100 placeholder-slate-600 focus:outline-none transition-colors text-sm" +
    " bg-white/[0.04] border border-white/[0.07] focus:border-blue-500/40 disabled:opacity-50";
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-slate-400 text-lg mb-10 leading-relaxed">
              ¿Tenés una idea o un problema que resolver? Escribinos y un
              miembro de nuestro equipo te contactará a la brevedad para
              analizar tu caso.
            </p>
              ...
              {[
                {
                  ...
                  label: "Email",
                  value: "hello@qunitrix.com",
                  href: "mailto:hello@qunitrix.com",
                },
                {
                  icon: "M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9",
                  label: "StockApp",
                  value: "stockapp.qunitrix.com",
                  href: "https://stockapp.qunitrix.com",
                },
                ...
                >
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-widest text-slate-600 font-bold mb-0.5">
                      {label}
                    </p>
                    <a
                      href={href}
          ...
          >
            {submitStatus === "success" && (
              <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/20 text-green-400 text-sm mb-2">
                ¡Mensaje enviado correctamente! Nos pondremos en contacto
                pronto.
              </div>
            )}
            {submitStatus === "error" && (
              <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm mb-2">
                Hubo un error al enviar el mensaje. Por favor, intentá
                nuevamente o envianos un email directamente.
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="mt-2 w-full flex justify-center items-center gap-2 px-8 py-4 rounded-xl font-bold text-white hover:scale-[1.02] transition-all electric-glow disabled:opacity-70 disabled:hover:scale-100 disabled:cursor-not-allowed"
              style={{
                background: "linear-gradient(135deg, #cc7a00, #f39200)",
              }}
            >
              {isSubmitting ? (
                <>
...
const Footer: React.FC = () => (
  <footer
    ...
    style={{ borderColor: "rgba(255,255,255,0.06)", background: "#1f2937" }}
  >
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
      ...
      <div className="md:col-span-2">
        <div className="flex items-center gap-3 mb-5">
          <img
            alt="Qunitrix Logo"
            className="h-7 w-auto grayscale opacity-75"
            src="/favicon.ico"
          />
          <span
        ...
        <p className="text-slate-600 text-sm leading-relaxed max-w-xs mb-6">
          Empresa de software especializada en soluciones empresariales.
          Desarrollamos tecnología que transforma negocios y potencia el
          crecimiento.
        </p>
      ...
      <div>
        <h5
          className="font-bold mb-5 uppercase text-xs tracking-widest"
          style={{ color: "#f39200" }}
        >
          Empresa
        </h5>
    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-700">
      ...
      <div className="flex gap-6">
        ...
        <Link to="/terminos" className="hover:text-slate-400 transition-colors">
...
const App: React.FC = () => {
  ...
  return (
    <div
      className="font-display overflow-x-hidden"
